  ...
  return (
    <div
      className={`
        ...
        {/* --- MOBİL CİHAZ STILLERİ (DEĞİŞİKLİK BURADA) --- */}
        {/* Artık alttan 24 birim (96px) boşluk bırakarak chat balonuna yer açıyoruz. */}
        {/* Yüksekliği ise üstten ve alttan sınırlayarak taşmasını engelliyoruz. */}
        bottom-24 right-4 left-4 top-16 

        {/* --- MASAÜSTÜ STILLERİ (DEĞİŞİKLİK BURADA) --- */}
        {/* Masaüstü için üst sınırı kaldırıp, yüksekliği ve konumu yeniden tanımlıyoruz. */}
        sm:top-auto sm:bottom-28 sm:left-auto sm:right-8 sm:w-full sm:max-w-sm sm:h-[60vh]
