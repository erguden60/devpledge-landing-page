...
export const ChatWindow = ({ isOpen, onClose }: ChatWindowProps) => {
  ...
  // Her yeni mesaj geldiğinde en alta otomatik olarak kaydır.
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 1. Kullanıcının mesajını anında ekle.
  ...
  return (
    <div
      className={`fixed bottom-28 right-8 z-50 w-full max-w-sm h-[60vh] bg-gray-800 rounded-2xl shadow-2xl flex flex-col transition-all duration-500 ease-in-out ${
        isOpen
